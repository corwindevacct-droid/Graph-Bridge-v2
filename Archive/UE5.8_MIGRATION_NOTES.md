> Archived from `origin/main` (unrelated history, preserved for reference — see `RELEASE_HISTORY.md`), commit `a3ba7bc` ("UE 5.8 migration: compiles clean against 5.8", 2026-08-01), branch tip at time of archival `3799aab`. Content below is unmodified from that commit.
