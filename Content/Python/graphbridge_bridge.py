...
class UnrealBridge:
    ...
    async def add_function_param(self, bp_path: str, function_name: str,
        ...
        params: comma-separated "Type:Name" pairs, e.g. "float:Damage,int32:Combo".
        For "out" parameters, a result node is created on demand if the function
        was void. If the function has several return paths, the pin is added to
        every result node — otherwise the function would not compile.
