...
namespace
{
    ...
    const TArray<FToolSpec>& GetToolSpecs()
    {
        static const TArray<FToolSpec> Specs = {
            ...
            { TEXT("ADD_MONTAGE_NOTIFY"), TEXT("Add a single-frame UAnimNotify to an AnimMontage timeline. For a begin/end window use ADD_MONTAGE_NOTIFY_STATE."),
              { {TEXT("asset_path"),TEXT("string")}, {TEXT("notify_class_name"),TEXT("string")}, {TEXT("time_seconds"),TEXT("number")} } },
            { TEXT("ADD_MONTAGE_NOTIFY_STATE"), TEXT("Add a UAnimNotifyState (begin/end window, e.g. a weapon hitbox) to an AnimMontage timeline. Duration must be > 0."),
              { {TEXT("asset_path"),TEXT("string")}, {TEXT("notify_class_name"),TEXT("string")}, {TEXT("start_seconds"),TEXT("number")}, {TEXT("duration_seconds"),TEXT("number")} } },
