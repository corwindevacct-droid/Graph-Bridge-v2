...
private:
    ...
    // Returns empty string on success, "ERR: <reason>" on failure. Detects
    // and reports the common argument-order mistake (swapping NodeId and GraphName).
    static FString DeleteNode(FString BlueprintPath, FString NodeId, FString GraphName = TEXT(""));
    ...
    // Returns empty string on success, "ERR: <reason>" on failure.
    static FString ClearNodes(FString BlueprintPath, FString CommentMatch, FString GraphName = TEXT(""));
    // Returns empty string on success, "ERR: <reason>" on failure.
    static FString SetPinDefault(FString BlueprintPath,
    ...
    // ------------------------------------------------------------------
    static FString AddFunctionParam(FString BlueprintPath, FString FunctionGraphName, FString Direction, FString CommaSeparatedParams);
    static FString RemoveFunctionParam(FString BlueprintPath, FString FunctionGraphName, FString Direction, FString ParamName);
    static FString AddCustomEventParam(FString BlueprintPath, FString EventNodeId, FString CommaSeparatedParams);
    static FString RemoveCustomEventParam(FString BlueprintPath, FString EventNodeId, FString ParamName);
